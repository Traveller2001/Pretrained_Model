...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_dir",
        default=SUPER_ROOT+'/model_deepspeedbs12/demo',
        type=str,
    ...
    parser.add_argument("--do_eval_during_train",default=True,action="store_true", help="Run evaluation during training at each logging step.",)
